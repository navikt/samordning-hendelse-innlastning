...
node {
    ...
    try {
        ...
        stage("checkout") {
            ...
            sh "git init"
            sh "git pull https://x-access-token:$appToken@github.com/navikt/samordning-hendelse-innlastning.git"
            ...
            github.commitStatus("pending", "navikt/samordning-hendelse-innlastning", appToken, commitHash)
        }
        ...
        stage("release") {
            ...
            sh "git push --tags https://x-access-token:$appToken@github.com/navikt/samordning-hendelse-innlastning HEAD:master"
        }
        ...
        github.commitStatus("failure", "navikt/samordning-hendelse-innlastning", appToken, commitHash)
